...
var input = [
  ...
  ["scalarmult", alice_curve.publicKey, bob_curve.secretKey],
  //buffer, nonce, key
  ...
  [
    "secretbox_open_easy",
    sodium.crypto_secretbox_easy(msgs[0], nonce, key),
    nonce,
    key,
  ],
  [
    "secretbox_open_easy",
    sodium.crypto_secretbox_easy(msgs[1], nonce, key),
    nonce,
    key,
  ],
  [
    "secretbox_open_easy",
    sodium.crypto_secretbox_easy(msgs[2], nonce, key),
    nonce,
    key,
  ],
